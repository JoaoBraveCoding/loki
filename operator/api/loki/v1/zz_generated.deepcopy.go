...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IngestStorageSpec) DeepCopyInto(out *IngestStorageSpec) {
	*out = *in
	in.Kafka.DeepCopyInto(&out.Kafka)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IngestStorageSpec.
func (in *IngestStorageSpec) DeepCopy() *IngestStorageSpec {
	if in == nil {
		return nil
	}
	out := new(IngestStorageSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LokiStackSpec) DeepCopyInto(out *LokiStackSpec) {
	*out = *in
	...
	if in.IngestStorage != nil {
		in, out := &in.IngestStorage, &out.IngestStorage
		*out = new(IngestStorageSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *LokiTemplateSpec) DeepCopyInto(out *LokiTemplateSpec) {
	*out = *in
	...
	if in.IngestLimits != nil {
		in, out := &in.IngestLimits, &out.IngestLimits
		*out = new(LokiComponentSpec)
		(*in).DeepCopyInto(*out)
	}
}
